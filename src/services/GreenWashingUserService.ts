...
const DEFAULT_ERROR_MESSAGE =
  'GreenWashingUserService error';

export class GreenWashingUserService {
  public static getUser = async (): Promise<ResponsePayload<IGreenWashingUser>> => {
    try {
      ...
      console.error(
        'GreenWashingUserService.getUser: ',
        error
      );
  ...
  public static createUser = async (): Promise<ResponsePayload<IGreenWashingUser>> => {
    try {
